...
<body>
    <div class="main-wrapper">
        <div class="menu-bar">
            <h3>メニュー</h3>
            <ul>
                <li><a href="${pageContext.request.contextPath}/main/StudentList.action">学生管理</a></li>
                ...
                <li><a href="${pageContext.request.contextPath}/main/SubjectList.action">科目管理</a></li>
            </ul>
        </div>
