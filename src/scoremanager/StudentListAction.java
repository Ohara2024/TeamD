        ...
        try {
            ...
            if (studentList != null) {
                for (Student student : studentList) {
                    System.out.println("学籍番号: " + student.getNo() + ", 名前: " + student.getName() + ", 在学中: " + student.isAttend());
                }
            } else {
            ...
            out.println("<table>");
            out.println("<thead><tr><th>学籍番号</th><th>氏名</th><th>入学年度</th><th>クラス</th><th>在学中</th><th>操作</th></tr></thead>");
            out.println("<tbody>");
            if (studentList != null) {
                for (Student student : studentList) {
                    String no = student.getNo();
                    String attendMark = student.isAttend() ? "〇" : "✖";
                    out.println("<tr>");
                    out.println("<td>" + no + "</td>");
                    out.println("<td>" + student.getName() + "</td>");
                    out.println("<td>" + student.getEntYear() + "</td>");
                    out.println("<td>" + student.getClassNum() + "</td>");
                    out.println("<td>" + attendMark + "</td>");
                    out.println("<td>");
